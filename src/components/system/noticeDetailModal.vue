    ...
    <table id="noticeInfo">
      ...
      <tbody>
        ...
        <tr v-if="paction == 'U'">
          ...
          <td>
            <input type="text" class="form-control" name="noticeNo" id="noticeNo" readonly v-model="noticeNo" />
          </td>
          <th scope="row">조회수</th>
          <td>
            <input type="text" class="form-control" name="noticeViewCnt" id="noticeViewCnt" readonly
        ...
        <tr>
          ...
          <td colspan="3">
            <input type="text" class="form-control" name="noticeTitle" id="noticeTitle" @keyup="handleTitle()"
              ref="title" v-model="noticeTitle" />
          </td>
        </tr>
        <tr>
          <th scope="row">내용<span class="font_red">*</span></th>
          <td colspan="3">
            <textarea class="form-control" name="noticeContent" id="noticeContent" @keyup="handleContent()"
              ref="content" rows="8" v-model="noticeContent"></textarea>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td colspan="3">
            <select id="noticeAuth" class="form-control" style="width: 150px" v-model="noticeAuth">
